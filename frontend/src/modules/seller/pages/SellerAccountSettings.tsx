...
const SellerAccountSettings = () => {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>, fieldName: 'profile' | 'logo' | 'storeBanner') => {
        ...
        try {
            ...
            // Upload using the existing uploadImage service
            const result = await uploadImage(file, 'dhakadsnazzy/branding');
            ...
            setError(err.message || `Failed to upload ${fieldName}`);
        } finally {
                                                    ...
                                                    <div className="relative group">
                                                        ...
                                                        {isEditing && (
                                                            <div
                                                                ...
                                                                className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-full cursor-pointer opacity-0 group-hover:opacity-100 transition-all duration-200 backdrop-blur-sm z-10"
                                                            >
                                                    ...
                                                    <div className="relative group flex-shrink-0">
                                                        ...
                                                        {isEditing && (
                                                            <div
                                                                ...
                                                                className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-xl cursor-pointer opacity-0 group-hover:opacity-100 transition-all duration-200 backdrop-blur-sm"
                                                            >
                                                                {uploadingField === 'logo' ? (
                                                                    <div className="w-5 h-5 border-2 border-t-transparent border-white rounded-full animate-spin"></div>
                                                                ) : (
                                                     ...
                                                     <div className="relative group rounded-xl overflow-hidden bg-gray-100 border-2 border-dashed border-gray-300 aspect-[21/9] transition-all hover:border-teal-300">
                                                         ...
                                                         {isEditing && (
                                                             <div
                                                                 ...
                                                                 className="absolute inset-0 flex items-center justify-center bg-black/40 cursor-pointer opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm"
                                                             >
